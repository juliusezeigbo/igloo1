...
class ComparesTest < ApplicationSystemTestCase
  ...
  test "creating a Compare" do
    ...
    fill_in "Description", with: @compare.description
    fill_in "Manufacturer code", with: @compare.manufacturer_code
    fill_in "Owner name", with: @compare.owner_name
    fill_in "Owner no", with: @compare.owner_no
    fill_in "Price", with: @compare.price
